...
public class ProductJpaEntity {
    ...
    public ProductJpaEntity(String name, BigDecimal price, String description, Category category) {
        this.name = name;
        this.price = price;
    ...
    public ProductJpaEntity(Long id, String name, BigDecimal price, String description, Category category) {
        this.id = id;
        this.name = name;
        this.price = price;
        this.description = description;
    ...
    public static ProductJpaEntity create(final Product product) {
        return new ProductJpaEntity(product.getName(), product.getPrice(), product.getDescription(), product.getCategory());
    }
    ...
    public static ProductJpaEntity from(final Category category) {
        return new ProductJpaEntity(null, null, null, category);
    }
